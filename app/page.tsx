...
export default function Page() {
  ...
  const heroSubtitle = useMemo(() => "Notion으로 가져오기", []);
  ...
  const onAddToNotion = async (it?: BookItem) => {
    ...
    if (!it) {
      setError("선택된 책 정보가 없어요. 다시 검색해줘!");
      return;
    }
    ...
    <main style={styles.page}>
      ...
      <section style={styles.shell}>
        <header style={styles.header}>
          ...
          <p style={styles.desc}>
            알라딘에서 책을 검색하고, 노션 DB에{" "}
            <span style={{ fontWeight: 800 }}>표지 / 저자 / 출판사 / 링크</span>를 자동 저장해요.
          </p>
        </header>
                ...
                <article key={it.itemId} style={styles.card}>
                  ...
                  <div style={styles.meta}>
                    ...
                    <div style={styles.actions}>
                      <a href={it.link} target="_blank" rel="noreferrer" style={styles.linkBtn}>
                        알라딘
                      </a>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  title: { margin: 0, fontSize: 32, letterSpacing: -0.6, lineHeight: 1.12 },
  ...
  resultsTitle: { fontSize: 13, letterSpacing: 0.3, opacity: 0.85 },

  resultsCount: { fontSize: 12, opacity: 0.55 },
  ...
  coverShadow: {
    ...
    borderRadius: 18,
    boxShadow:
      "inset 0 0 0 1px rgba(255,255,255,0.12), inset 0 -40px 70px rgba(0,0,0,0.6)"
  },
  ...
  subLine: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
